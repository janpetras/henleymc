...
module.exports = function ClientJsModule(pb) {
    ...
    ClientJs.getAngularController = function(objects, modules, directiveJS) {
        ...
        var angularController = "var pencilblueApp = angular.module('pencilblueApp', " + JSON.stringify(modules) + ").constant('euiHost', 'https://main:vkspkxpn9hizazil2rznnahsfldjouak@kili-eu-west-1.searchly.com')";
