                ...
                if(tempLayoutArray.length > 1) {
                    ...
                    for(i = 0; i < tempLayoutArray.length && i < contentSettings.auto_break_articles; i++) {
                        if(i === contentSettings.auto_break_articles -1 && i != tempLayoutArray.length - 1) {
                            newLayout += tempLayoutArray[i] + '&nbsp;<div><a class="actionbtn" href="' + pb.config.siteRoot + '/article/' + article.url + '">' + contentSettings.read_more_text + '</a>&nbsp;<a class="actionbtn" id="book_' + article.id + '"' + 'href="' + pb.config.siteRoot + '/book' + '">' + contentSettings.book_now_text + '</a></div>' + breakString;
                            continue;
                        }
